		...
		<div class="sap_tabs">
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				...
				<!-- Start of contents -->
					...
					?>														
						<div class="col-md-3 product-men yes-marg" style="height: 500px;">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="images/Men/<?php echo $fileExt[0]?>.png" alt="{$row['pid']}" class="pro-image-front">
									<img src="images/Men/<?php echo $fileExt[0]?>.png" alt="{$row['pid']}" class="pro-image-back">

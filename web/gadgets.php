						...
						<div class="col-md-3 product-men"style="height: 500px;">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="images/gadgets/<?php echo $fileExt[0]?>.png" alt="{$row['pid']}" class="pro-image-front">
									<img src="images/gadgets/<?php echo $fileExt[0]?>.png" alt="{$row['pid']}" class="pro-image-back">

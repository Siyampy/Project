					...
					while($row = mysqli_fetch_assoc($result))
					{
					 ...
					 ?>														
						<div class="col-md-3 product-men"style="height: 500px;">
							<div class="men-pro-item simpleCart_shelfItem" style="height: 450px;">
								...
								<div class="item-info-product ">
									...
									<div class="info-product-price">
										<span class="item_price"><?php echo $row1['price'] ?></span>
										<del><?php echo ($row1['price']+500) ?></del>
									</div>									
									<a href="admin_rate_confirm.php?pid=<?php echo $row1['pid'] ?>" class="item_add single-item hvr-outline-out button2">Rate Product</a>																			
								</div>
							</div>
						</div>

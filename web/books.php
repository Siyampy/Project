						...
						<div class="col-md-3 product-men" style="height: 500px;">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="images/Books/<?php echo $fileExt[0]?>.png" alt="{$row['pid']}" class="pro-image-front">
									<img src="images/Books/<?php echo $fileExt[0]?>.png" alt="{$row['pid']}" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="shop_cart.php?pid=<?php echo $row['pid'] ?>" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
								...
								<div class="item-info-product "style="height: 150px;">
									...
									<a href="shop_cart.php?pid=<?php echo $row['pid'] ?>" class="item_add single-item hvr-outline-out button2">Buy</a>																			
								</div>
							</div>
						</div>

								...
								<div class="login">
									...
									<div class="login-right">
										<h3>Add Product details</h3>
											...
											<form action="add_product_confirm.php" method="POST" enctype="multipart/form-data">
											<div class="sign-in">
                                            ...
                                            <div class="sign-in">
												<h4>Product Name(Only Alphabets and numbers) :</h4>
                                            ...
                                            <div class="sign-in">
												<h4>Price (Number) :</h4>
												<input type="text" name="price" value="Enter price" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter price';}" required="">
                                            </div>
                                            <div class="sign-in">
												<h4>Image :</h4>
												<input type="file" name="file" value="Choose Image file" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Choose Image file';}" required="">
                                            </div>
                                            <div class="sign-in">
												<h4>Description :</h4>
												<input type="text" name="info" value="Give description" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Give description';}" required="">
                                            </div>

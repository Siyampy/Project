				  ...
				  <!-- Collect the nav links, forms, and other content for toggling -->
					  ...
					  if($login==1)
					  {
						?>  
									...
									<li class=" menu__item"><a class="menu__link" href="rate_products.php">Rate</a></li>
					  ...
					  ?>
					  				<li class=" menu__item"><a class="menu__link" href="add_products.php">Add </a></li>
									<li class=" menu__item"><a class="menu__link" href="add_products.php">Delete</a></li>
									<li class=" menu__item"><a class="menu__link" href="add_products.php">Rate</a></li>
									<li class=" menu__item"><a class="menu__link" href="add_products.php">Remove Fake</a></li>
									<li class=" menu__item"><a class="menu__link" href="contact.php">Contact</a></li>
									<li class=" menu__item"><a class="menu__link" href="adminlogin.php">Login</a></li>
						<?php
					  }
					  ?>
								</ul>
